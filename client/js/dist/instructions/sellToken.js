...
export function getSellTokenInstructionDataCodec() {
    return combineCodec(getSellTokenInstructionDataEncoder(), getSellTokenInstructionDataDecoder());
}
export async function getSellTokenInstructionAsync(input, config) {
    ...
    const instruction = {
        ...
        programAddress,
        data: getSellTokenInstructionDataEncoder().encode(args),
    };
    return instruction;
}
export function getSellTokenInstruction(input, config) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    // Program address.
    const programAddress = (_a = config === null || config === void 0 ? void 0 : config.programAddress) !== null && _a !== void 0 ? _a : PUMP_PROGRAM_ADDRESS;
    // Original accounts.
