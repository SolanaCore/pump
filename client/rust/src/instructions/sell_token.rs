...
impl SellToken {
  pub fn instruction(&self, args: SellTokenInstructionArgs) -> solana_instruction::Instruction {
...
#[inline(always)]
    pub fn associated_token_program(&mut self, associated_token_program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn max_token(&mut self, max_token: u64) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SellToken {
          ...
          let args = SellTokenInstructionArgs {
                                                              max_token: self.max_token.clone().expect("max_token is not set"),
                                    };
...
impl<'a, 'b> SellTokenCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn associated_token_program(&mut self, associated_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn max_token(&mut self, max_token: u64) -> &mut Self {
        self.instruction.max_token = Some(max_token);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = SellTokenInstructionArgs {
                                                              max_token: self.instruction.max_token.clone().expect("max_token is not set"),
                                    };
