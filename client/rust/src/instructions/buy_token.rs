...
impl BuyToken {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: BuyTokenInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[inline(always)]
    pub fn associated_token_program(&mut self, associated_token_program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn max_sol(&mut self, max_sol: u64) -> &mut Self {
        self.max_sol = Some(max_sol);
        self
      }
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = BuyToken {
          ...
          let args = BuyTokenInstructionArgs {
                                                              max_sol: self.max_sol.clone().expect("max_sol is not set"),
                                    };
...
impl<'a, 'b> BuyTokenCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn associated_token_program(&mut self, associated_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn max_sol(&mut self, max_sol: u64) -> &mut Self {
        self.instruction.max_sol = Some(max_sol);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = BuyTokenInstructionArgs {
                                                              max_sol: self.instruction.max_sol.clone().expect("max_sol is not set"),
                                    };
